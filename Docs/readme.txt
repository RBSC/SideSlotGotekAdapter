...
IMPORTANT! The emulator is not locked in the adapter's case, so be careful when inserting/removing the adapter into/from the side
slot. Never pull or push the adapter into the slot by the emulator's case! Always push or pull the adapter into/out of the side
slot by its thick front or back case's surfaces!
